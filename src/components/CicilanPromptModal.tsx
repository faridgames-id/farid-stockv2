...
interface CicilanPromptModalProps {
  isOpen: boolean;
  onClose: () => void;
  account: AccountItem | null;
  onSubmit: (accountId: string, buyerName: string) => void;
}

const CicilanPromptModal: React.FC<CicilanPromptModalProps> = ({ isOpen, onClose, account, onSubmit }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (account) {
      onSubmit(account.id, buyerName.trim());
      onClose();
    }
  };
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-blue-50/90 mb-6 leading-relaxed">
                Ingin memasukkannya ke cicilan? Jika iya, silakan masukkan nama pembeli di bawah ini.
              </p>
...
export default CicilanPromptModal;
